...
public class MockLocationTests {
    ...
    /**
     * Test that optional replan popup appears when user has gone off-route, and is closer to another chosen
     * exhibit later in the route, which the user declines.
